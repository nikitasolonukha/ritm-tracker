...
Кодовый commit: `590b171` (`fix: preserve both sync conflict versions`).
...
- Текущий подтвержденный production deployment: `dpl_FoBz6bZ1zxxW29w4rMUaTP6TMPnX` (READY), alias `https://ritm-tracker.vercel.app/`.
