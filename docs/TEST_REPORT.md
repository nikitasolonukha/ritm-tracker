...
Кодовый commit: `1922ceb` (`fix: fail closed without owner configuration`).
...
- Текущий подтвержденный production deployment: `dpl_6RDCGkW6pdxrqF5msn26QicVoWLi` (READY), alias `https://ritm-tracker.vercel.app/`.
